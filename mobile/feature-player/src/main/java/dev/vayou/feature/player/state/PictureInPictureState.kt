...
class PictureInPictureState(
    ...
    private fun updatePictureInPictureActions() {
        ...
        val actions = listOf(
            createPipAction(
                context = activity,
                title = activity.getString(coreUiR.string.skip_to_previous),
            ...
            if (isPlaying) {
                createPipAction(
                    context = activity,
                    title = activity.getString(coreUiR.string.pause),
                ...
                createPipAction(
                    context = activity,
                    title = activity.getString(coreUiR.string.play),
            ...
            createPipAction(
                context = activity,
                title = activity.getString(coreUiR.string.skip_to_next),
